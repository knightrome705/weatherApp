        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              Text('19 C',style:AppTextStyle.heading2 ,),
              const Text('Precipations',style: TextStyle(fontSize: 20,color: Colors.white),),
              const Row(
              ...
              Row(
                ...
                children: [
                 const Icon(Icons.location_on,color: Colors.white,),
                  InkWell(onTap: () => Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) =>const Main(),)),  child: Icon(Icons.add,color: Colors.white,)),
